...
let countDown = new Date(`${config.birthdate} 04:40:00`).getTime();
x = setInterval(function() {
  ...
  function anim() {
    ...
    if (done) window.location.href = "https://www.canva.com/design/DAFE2zvQVIk/4PedPT3Pn09nOArYUiqHLw/view?utm_content=DAFE2zvQVIk&utm_campaign=designshare&utm_medium=link2&utm_source=sharebutton";
  }
